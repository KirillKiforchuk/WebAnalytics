...
class TestData(object):
    def test1(self):
        # WebAnalytics trivial file with nothing.
        self._test(test4)

    def test2(self):
        # WebAnalytics trivial file with some comments in the data section.
        self._test(test5)

    def test3(self):
        # WebAnalytics trivial file with nominal attribute of 1 character.
        self._test(test6)
...
class TestHeader(object):
    ...
    def test_fullheader1(self):
        # WebAnalytics trivial header with nothing.
        ofile = open(test1)
        rel, attrs = read_header(ofile)
        ofile.close()
